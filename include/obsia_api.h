...
typedef struct {
    ...
    int n_threads;               // Number of CPU threads (default 2 for mobile)
    int n_ctx;                   // Context window (default 1536)
...
// Returns a pointer to an internal static/thread-local buffer containing the response.
